...
async function linkSpecificUserToSolar() {
  try {
    await connectDB();

    // Find the second user (kasunnilaweera2@gmail.com)
    ...
    // Find solar unit SU-0004 (which has energy records)
